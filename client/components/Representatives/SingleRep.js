      ...
      <Card className={classes.card}>
        ...
        <CardActions>
          <Button className='social-icons' size="small" color="primary">
            ...
            <a href={rep.url} target="_blank">website</a>

          </Button>
          <Button className='social-icons' size="small" color="primary">
            <Icon className={classes.icon}>phone</Icon>
            <a href={rep.url} target="_blank">773.475.3283</a>
        ...
        <CardActions>
          ...
          <Button className='social-icons' size="small" color="primary">
            ...
            <a href={rep.url} target="_blank"></a>
        ...
        <CardActions>
          <Button className='social-icons collect-points' size="small" color="primary">
            <span className='collect-points'>  I CONTACTED THIS REP, COLLECT MY POINTS
</span>
